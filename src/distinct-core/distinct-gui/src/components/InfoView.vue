  ...
  <div class="container">
    <div class="row">
      <div class="col border border-1 bg-light rounded-3">
        ...
        <dl>
          <dt>
            <router-link class="link-dark" to="/browser">
