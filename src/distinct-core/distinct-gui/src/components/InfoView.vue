  ...
  <div class="container">
    <div class="row">
      <div class="col border border-1 bg-light rounded-3">
        ...
        <p><span style="font-variant: small-caps">Distinct</span> provides a fully fledged Single Sign-On security analysis framework for modern communication techniques. It was developed for the <a href="/paper.pdf">paper</a> <i>"DISTINCT: Identity Theft using In-Browser Communications in Dual-Window Single Sign-On"</i>. <span style="font-variant: small-caps">Distinct's</span> dynamic analysis approach automates the (1) capturing, (2) detection, (3) visualization, (4) security analysis, and (5) exploitation of Single Sign-On flows relying on novel in-browser communication techniques.</p>
        <p>Check out the <a href="/paper.pdf">paper</a> or the <a href="https://github.com/RUB-NDS/DISTINCT">source code</a> to find out more.</p>
        <h5>Abstract</h5>
