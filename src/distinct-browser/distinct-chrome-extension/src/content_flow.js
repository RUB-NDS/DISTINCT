...
let content_flow = () => {
    ...
    if (
        ...
        _sso._event("statement", {"key": "idp", "val": "apple"});
        _sso._event("statement", {"key": "loginrequrl", "val": location.href});
        _sso._event("statement", {"key": "loginreqframe", "val": _sso._hierarchy(window)});

        if (window.parent === self && window.opener == null) {
            _sso._event("statement", {"key": "flow", "val": "textbook"});
        } else if (window.opener) {
            _sso._event("statement", {"key": "flow", "val": "popup"});
        } else if (window.parent !== self) {
            _sso._event("statement", {"key": "flow", "val": "iframe"});
        }
    }
    ...
    if (
        ...
        _sso._event("statement", {"key": "idp", "val": "facebook"});
        _sso._event("statement", {"key": "loginrequrl", "val": location.href});
        _sso._event("statement", {"key": "loginreqframe", "val": _sso._hierarchy(window)});
    ...
    if (
        ...
        _sso._event("statement", {"key": "idp", "val": "google"});
        _sso._event("statement", {"key": "loginrequrl", "val": location.href});
        _sso._event("statement", {"key": "loginreqframe", "val": _sso._hierarchy(window)});
    ...
    if (
        ...
        _sso._event("statement", {"key": "loginrespurl", "val": location.href});
        _sso._event("statement", {"key": "loginrespframe", "val": _sso._hierarchy(window)});
        _sso._event("statement", {"key": "loginresptype", "val": "GET"});
    ...
    function formsubmit(e) {
        ...
        if (
            ...
            _sso._event("statement", {"key": "loginrespurl", "val": target.action});
            _sso._event("statement", {"key": "loginrespframe", "val": _sso._hierarchy(window)});
            _sso._event("statement", {"key": "loginresptype", "val": "POST"});
        }
